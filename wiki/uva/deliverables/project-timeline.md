...
**Status:** referenced (Gantt image-only); 12-week/3-phase structure known textually; **final-demo / thesis-defence date pinned to 2026-06-22**
...
- **Concrete end-of-project schedule (2026-06-15 meeting):**
  - **Wed 2026-06-17** — Quinten + Laurenz design the evaluation framework / ingestion-evaluation experiment (text-generation evaluation).
...
- 2026-06-17 → 2026-06-22 — final demo run-up: eval-framework design (17.06), Sanne demo + re-ingest (18.06), fake-project ingest (19.06), **final demo + thesis defence (22.06)**.
