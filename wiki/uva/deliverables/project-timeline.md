...
**Status:** referenced (Gantt image-only); 12-week/3-phase structure known textually; **final-demo / thesis-defence date pinned to 2026-06-22**; **multi-project app built 2026-06-17**; **Friday 2026-06-20 final integration demo added**; **post-defence meeting planned**

## Summary
A **project Gantt chart / timeline** for the Living Wiki exists, dated **2026-04-13** (the kickoff day). The chart artifact is **a single embedded image** (CDN-hosted JPG) with **no extractable text**, so its visual contents (phases, tasks, durations, milestones) are **not ingested**. However, the **Assignment 1 presentation** (see [[assignment-1-presentation-2026-04-22]]) supplies an explicit **12-week / 3-phase** schedule textually, and the **2026-06-15 team meeting** (see [[team-meeting-2026-06-15]]) pins concrete **end-of-project dates** (final demo + thesis defence on **2026-06-22**). The **2026-06-18 final demo check-in** (see [[team-meeting-2026-06-18]]) adds two further milestones: a **Friday 2026-06-20 final integration demo** and a **post-defence Thursday evening meeting** (Bakkie demo).
...
- **Concrete end-of-project schedule (2026-06-15 + 2026-06-18 meetings):**
  ...
  - **Thu 2026-06-18** — **Final demo to Sanne** + final feedback; then re-ingest project docs into an empty wiki. Sanne confirmed internal-use intent; Vercel decided against (see [[team-meeting-2026-06-18]]).
  - **Fri 2026-06-19** — Ingest a fake KickstartAI project as a new-project use-case.
  - **Fri 2026-06-20** — **Final integration demo** (team + Sanne review all final details). Added at [[team-meeting-2026-06-18]]. See [[_gaps]].
  ...
  - **Post-defence Thursday evening** — team plans to meet to review decisions + supervisor feedback + **demo the Bakkie project** to Sanne. See [[team-meeting-2026-06-18]], [[_gaps]].
...
- **2026-06-18** — final demo to Sanne; Vercel decided against; KickstartAI internal-use intent confirmed; re-ingest project docs.
- **2026-06-19** — evaluation runplan ingested; fake KickstartAI project ingest.
- **2026-06-20** — final integration demo (Friday; team review all final details).
- **2026-06-22** — **final demo of the artifact + individual thesis defence.**
- **Post-22.06 Thursday evening** — post-defence meeting: review decisions + feedback + Bakkie demo.
