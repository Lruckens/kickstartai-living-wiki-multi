...
**Status:** scoped (Should Have); **built — 6-layer hybrid framework with UI (2026-06-12); integrated as a dashboard + report page (2026-06-15); demoed to Sanne with broken-link detection detail (2026-06-18)**

## Summary
Identifies underdocumented areas, unresolved decisions, or missing rationale — e.g., decisions without rationale, PRs without explanations, meetings without recorded outcomes. Outputs a **structured, ranked gap report** highlighting missing or incomplete knowledge. As of **2026-06-12** a working **6-layer hybrid implementation** exists (see [[mockup-artifact-2026-06-12]]); by **2026-06-15** it is integrated into the wiki UI as a **dashboard + report page** (see [[team-meeting-2026-06-15]]); by **2026-06-18** it was demoed to Sanne with additional detail on broken-link detection (see [[team-meeting-2026-06-18]]).
...
### Broken-link detection — more specific description (2026-06-18)
At the 2026-06-18 final demo (see [[team-meeting-2026-06-18]]), the system was described as alerting users to **broken links** with the **exact location** of the broken link and **fix recommendations**. This is consistent with the Lint operation / gaps dashboard behaviour but provides more specific detail than prior descriptions. The dashboard organizes issues by priority (high/medium/low) and detection method (rule-based/semantic/graph-based).
