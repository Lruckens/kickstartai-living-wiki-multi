...
## Open questions
See [[_gaps]] for the full list (full timeline, tech stack, source connectors, regeneration cadence, tone spec, student name-mapping, supervisor role, mentor labeling).
