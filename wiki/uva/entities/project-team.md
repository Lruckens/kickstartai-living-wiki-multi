...
> **Residual:** which *named student* is Member 1/2/3/4 is **not stated** in either artifact — owners-by-component resolved, owners-by-person still open. A **soft signal** (strengthened 2026-05-15) is that **Laurenz holds the GitHub/wiki-architecture MVP and is its contact** — consistent with, but not proof of, Laurenz = Member 1 (Ingestion + Wiki Engine). Not asserted. See [[_gaps]].
